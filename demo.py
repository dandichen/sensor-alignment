...
test_path = '/mnt/scratch/sync_sd/car_record/demo/' + date
out_path_cam1 = '/mnt/scratch/sync_sd/car_record/demo/' + date + '/binocular_camera/20160616-1-cam1-sync.avi'
out_path_cam2 = '/mnt/scratch/sync_sd/car_record/demo/' + date + '/binocular_camera/20160616-1-cam2-sync.avi'
out_path_dms = '/mnt/scratch/sync_sd/car_record/demo/' + date + '/binocular_camera/20160616-1-dms-sync.avi'
...
def main():
    ...
    human_time2, epoch_time2, file_name2, frame_idx2 = read_data(
        test_path + '/alignment/cam1.txt')
    file_list2, drop_idx2, drop_num2 = img2video(file_name2, frame_idx2, fps1,
